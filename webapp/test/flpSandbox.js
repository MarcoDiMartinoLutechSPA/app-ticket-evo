		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ticket/Evo App",
									"targetURL": "#sapbtpappticketevo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpappticketevo-display": {
								"semanticObject": "sapbtpappticketevo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.appticketevo",
									"url": sap.ui.require.toUrl("sap/btp/appticketevo")
								}
							}
						}
					}
